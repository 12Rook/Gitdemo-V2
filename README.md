...
The project is part of an exercise to practice working with real-world data in R Markdown.

## Files Included
- `Class1SurveyF2026.csv`: Cleaned version of the Class 1 survey dataset
- `Class1Survey.Rmd`: R script used to summarize and visualize the data
- `README.md`: This file
